  ...
  return (
    <div className="bg-black text-white h-full w-full">
        <div className="lg:p-20 px-3 py-10 w-full">
            <h1 className='lg:text-5xl lg:max-w-[70%] text-3xl font-bold text-white '>Starting a new project or want to collaborate with us? 
           
            <a className='text-orange-600 px-2 font-bold'>Let’s talk </a></h1>
            <p className='py-2 lg:text-5xl text-zinc-800 hover:text-zinc-700 font-medium text-3xl'>hello@nexionconnect.in</p>
        </div>
        ...
        <div className="w-full lg:pl-20 lg:flex lg:max-w-[90%] p-5 justify-between">
            <div className="flex-col flex justify-around h-[320px]">
                ...
                <a className='hover:text-orange-600'>Agency</a>
                <a className='hover:text-orange-600'>Services</a>
                <a className='hover:text-orange-600'>Industries</a>
                <a className='hover:text-orange-600'>Client Testimonial</a>
                <a className='hover:text-orange-600'>Contact</a>
                <a className='hover:text-orange-600'>Website Accessbility</a>
            </div>
            <div className="flex flex-col justify-around h-[300px]">
                ...
                <a className='hover:text-orange-600'>WordPress Websites</a>
                <a className='hover:text-orange-600'>Branding</a>
                <a className='hover:text-orange-600'>Web Design</a>
                <a className='hover:text-orange-600'>Graphic Design</a>
                <a className='hover:text-orange-600'>Real Estate Design</a>

           </div>
            <div className="flex flex-col mt-4">
                <p className='pt-3 text-lg font-bold border-t-2 w-max'>Address</p>
                <p className='lg:py-4 lg:w-[150px] text-justify'>85 Broad Street
...
<p className='hover:text-orange-600 px-2 pb-3'>hello@dd.nyc</p>
            ...
            <div className="flex flex-col lg:h-[250px] justify-around">
                ...
                <p className='pt-1 hover:text-orange-600'>aedIn</p>
       ...
       <div className="w-full flex lg:flex-row flex-col justify-between lg:p-10 p-5 lg:mt-24 items-center h-full ">
